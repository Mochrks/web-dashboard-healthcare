...
const differentialDiagnoses = ref([
  {
    patient: 'Michael Chang',
    conf: 94,
    assessment: 'Pulmonary Embolism vs Acute MI',
    icd: 'I21.9',
    recommendation: 'Stat CT Angio Chest'
  },
  {
    patient: 'Sarah Jenkins',
    conf: 88,
    assessment: 'Sepsis secondary to UTI',
    icd: 'A41.9',
    recommendation: 'Lactate + Blood Cultures'
  }
])
