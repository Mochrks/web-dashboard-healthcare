...
import { Activity, Search, Filter, RefreshCw, MessageSquareDashed } from 'lucide-vue-next'
...
const messageThreads = ref([
  {
    ...
    preview: 'The labs for Rm 204 are ready...',
    time: '10:42 AM',
    self: false
  },
  { from: 'You', preview: 'Thanks, reviewing them now.', time: '10:45 AM', self: true },
  {
    from: 'Marcus Webb, RN',
    preview: 'Patient in bed 3 needs a meds adjustment.',
    time: '09:15 AM',
    self: false
  }
])
