...
const complianceItems = ref([
  { name: 'Joint Commission Audit', desc: 'Annual review passed', passed: true },
  { name: 'HIPAA Recertification', desc: 'Staff training module', passed: true },
  { name: 'OSHA Safety Review', desc: 'Facility compliance due', passed: false }
])
