...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tailwind%20CSS-4.x-06b6d4?style=for-the-badge&logo=tailwindcss" alt="Tailwind CSS Version" />
  <img src="https://img.shields.io/badge/TypeScript-5.x-blue?style=for-the-badge&logo=typescript" alt="TypeScript Version" />
  <img src="https://img.shields.io/badge/Pinia-3.x-ffe082?style=for-the-badge&logo=pinia" alt="Pinia Version" />
  <img src="https://img.shields.io/badge/Vite-6.x-646CFF?style=for-the-badge&logo=vite" alt="Vite Version" />
</p>
...
- **TypeScript** (Strict type definitions for medical schemas)
- **Pinia** (State storage for real-time operations, chat logs, and medical records)
...
- **Prettier:** Code formatter for consistent style rules.
- **Husky:** Runs automated quality checks before commits can be written to git.
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/Mochrks/web-dashboard-smart-building.git
   cd web-dashboard-smart-building
   ```
...
4. **Format the codebase manually**
